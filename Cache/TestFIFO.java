/*
Unit tests for cache with FIFO page replacement algorithm

Compiling: javac TestFIFO.java
Running: java TestFIFO
*/
...
public class TestFIFO
{
	...
	{
		Cache<String> cache = new Cache<String>(3, Cache.Strategy.FIFO);
		...
		cache.put(7, "seventh");
		cache.put(8, "eighth");
		ts.assertEQ(cache.get(5), null, "test 5.0");
		ts.assertEQ(cache.get(8), "eighth", "test 5.1");
		ts.assertEQ(cache.get(7), "seventh", "test 5.2");
		ts.assertEQ(cache.get(6), "sixth", "test 5.3");
		ts.tally();
	}
}
